...
exports.handler = async function(context, event, callback) {
    ...
    async function createChatCompletion(messages) {
        try {
            ...
            // console.error("OpenAI API Response:", JSON.stringify(completion, null, 2));
    ...
    function formatConversation(conversation) {
        ...
        const messages = [{
                role: "system",
                content: "You are a creative, funny, friendly and amusing AI assistant named Joanna. Please provide engaging but concise responses and also understand hindi language",
            },
            {
                role: "user",
                content: "We are having a casual conversation over the telephone so please provide engaging but concise responses if possible then in hindi.",
            },
        ];
