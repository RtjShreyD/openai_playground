...
def Service_request(input_string):
...
tools=[Tool(
        ...
        description="useful for when you need to answer questions about the most relevant serial_id of service request according to their specilisation.This list of servicemen belong to given service request and serial_id according to people",
        ), Tool(
    name="service_request",
    func=Service_request,
    description="Useful when want to make a service request to the servicemen." 
    "Takes an input json string containing serial_id, servicemen."
    "servicemen should be a list containing serial_id of relevant individual servicemen." 
    "It should be able to identify and return only the serial_id of a specific serviceman based on the provided details." 
    "This functionality will allow users to easily retrieve the serial_id for a particular serviceman, streamlining the service request process and making it more efficient."
)]
